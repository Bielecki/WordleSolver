...
- Script operates in `hard mode` of Wordle, where "any revealed hints must be used in subsequent guesses". You can mitigate this behavior by providing your own word (sometimes you have lot of similar, potentially correct words, and might need to exclude more letters in single guess, as you have only 6 guesses overall).
